...
async function configFromJobInput() {
    ...
    const commitMessage = core.getInput('commit-message') || undefined;
    const commitUserName = core.getInput('commit-user-name') || undefined;
    const commitUserEmail = core.getInput('commit-user-name') || undefined;
    const outputFormat = core.getInput('output-format') || undefined;
